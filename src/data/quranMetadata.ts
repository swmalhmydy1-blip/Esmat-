...
import { SurahMetadata, Reciter } from "../types";
...
export const quranSurahs: SurahMetadata[] = [
  ...
  { number: 26, name: "الشعراء", englishName: "As-Shu'ara", englishNameTranslation: "The Poets", numberOfAyahs: 227, revelationType: "Meccan" },
  ...
  { number: 42, name: "الشورى", englishName: "As-Shura", englishNameTranslation: "The Consultation", numberOfAyahs: 53, revelationType: "Meccan" },
  ...
  { number: 54, name: "المرسل", englishName: "Al-Qamar", englishNameTranslation: "The Moon", numberOfAyahs: 55, revelationType: "Meccan" },
  ...
  { number: 91, name: "الشمس", englishName: "As-Shams", englishNameTranslation: "The Sun", numberOfAyahs: 15, revelationType: "Meccan" },
  ...
  { number: 94, name: "الشرح", englishName: "As-Sharh", englishNameTranslation: "The Relief", numberOfAyahs: 8, revelationType: "Meccan" },
...
export const reciters: Reciter[] = [
  { id: "ar.alafasy", name: "مشاري راشد العفاسي", arabicName: "مشاري بن راشد العفاسي", style: "مرتل", serverUrl: "https://audio.qurancdn.com/Alafasy/mp3/" },
  { id: "ar.abdulbasit", name: "عبد الباسط عبد الصمد", arabicName: "عبد الباسط عبد الصمد (مرتل)", style: "مرتل", serverUrl: "https://audio.qurancdn.com/AbdulBaset/Murattal/mp3/" },
  { id: "ar.husary", name: "محمود خليل الحصري", arabicName: "محمود خليل الحصري", style: "مرتل", serverUrl: "https://audio.qurancdn.com/Husary/Muallim/mp3/" },
  { id: "ar.minshawi", name: "محمد صديق المنشاوي", arabicName: "محمد صديق المنشاوي (مرتل)", style: "مرتل", serverUrl: "https://audio.qurancdn.com/Minshawi/Murattal/mp3/" },
  { id: "ar.sudais", name: "عبد الرحمن السديس", arabicName: "عبد الرحمن السديس", style: "مرتل", serverUrl: "https://audio.qurancdn.com/Sudais/mp3/" }
];
